...
© 2026 SHL and its affiliates. All rights reserved. | Page 1 of 5
...
3. If you clear the scoring threshold: a technical deep-dive on your code, an experience & projects round, and a

hiring-manager conversation on culture fit.


Version: X.X | Last updated: XX XXXX 20XX


© 2026 SHL and its affiliates. All rights reserved. | Page 2 of 5
...
The catalog you build over is the SHL product catalog at **[https://www.shl.com/solutions/products/product-](https://www.shl.com/solutions/products/product-catalog/)**
**[catalog/](https://www.shl.com/solutions/products/product-catalog/)**, restricted to **Individual Test Solutions** only. Pre-packaged Job Solutions are out of scope.
...
© 2026 SHL and its affiliates. All rights reserved. | Page 3 of 5
...
**Health check.** `GET /health` returns `“status": "ok"}` with HTTP 200. For cold start hosting services, the first /health
...
We provide the following things.
  ...
  - Here is the SHL catalogue: **[Link](https://tcp-us-prod-rnd.shl.com/voiceRater/shl-ai-hiring/shl_product_catalog.json)**
...
implementation. You can download the zip with these conversations from here: **[Link](https://tcp-us-prod-rnd.shl.com/voiceRater/shl-ai-hiring/sample_conversations.zip)**
...
Submit the following via the form ( **[Link](https://shl1.fra1.qualtrics.com/jfe/form/SV_2m1srBsjt2q1r8y)** ).
